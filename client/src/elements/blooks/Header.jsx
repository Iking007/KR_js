...
function Header(){
    return(
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom" id="head">
            <Link to="/" class="d-flex align-items-center text-dark text-decoration-none">
                ...
                <span class="fs-4">Books only</span>
            </Link>

            <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                <form class="d-flex" action="/books/query" method="get">
                    <input type="text" autocomplete="off" name="filter" class="form-control my_input" placeholder="Книга"/>
                    <button type="submit" class="my_button">
                        Поиск
                    </button>
                </form>
                ...
                {localStorage.token != null ? <Link class="me-3 py-2 text-dark text-decoration-none my_link" to="/favorites">Избранное</Link>: null}
